    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Logs", x => x.ErrorId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AutoApproveComments = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DefaultCommentsEnabled = table.Column<bool>(type: "bit", nullable: false),
                    DefaultAutoApproveComments = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostAudiences", x => new { x.PostId, x.UserId });
                    table.ForeignKey(
